...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 400, description: 'Dados inválidos ou validação falhou' }),
    (0, swagger_1.ApiResponse)({ status: 409, description: 'Email ou CNPJ já cadastrado' }),
